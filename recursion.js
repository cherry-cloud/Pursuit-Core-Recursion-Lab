...
// ```js
console.log(multArr([2, 3, 5])); // returns 30
console.log(multArr([5, 5, 1, 2])); //returns 50
// ```
...
// ```js
console.log(concatArr(['is', 'it', 'tomorrow'])); // returns 'is it tomorrow'
console.log(concatArr(['or', 'just', 'the', 'end', 'of', 'time'])); //returns 'or just the end of time'
// ```
...
// ```js
console.log(sumEvens([2, 3, 5, 6])); // returns 8
console.log(sumEvens([10, 5, 1, 2, 12])); //returns 24
// ```
